...
const updateTransactionService = (foundUser, transactions_id, updatedData) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    const updatedTransaction = Object.assign(Object.assign({}, findTransaction), updatedData);
    updatedTransaction.updated_at = new Date();
    yield transactionsRepository.update(transactions_id, updatedTransaction);
